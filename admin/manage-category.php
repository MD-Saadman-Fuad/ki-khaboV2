            ...
            ?>
                    <tr>
                        ...
                        <td><?php
                            if ($image_name != "") {
                            ?>
                                <img src="<?php echo SITEURL; ?>images/category/<?php echo $image_name; ?>" alt="" height="50px" width="80px">
                            <?php
                        ...
                        <td>
                            ...
                            &image_name=<?php echo $image_name; ?>" class="btn-red">Delete Category</a>
                        </td>
                    </tr>
                <?php
                }
                ...
                <tr>
                    <td colspan="6">
                        <div class="red">No Category Added
                    </td>
                </tr>
