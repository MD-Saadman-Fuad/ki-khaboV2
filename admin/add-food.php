...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO food SET title=?, description=?, price=?, image_name=?, category_id=?, featured=?, active=?";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "ssissss", $title, $description, $price, $image_name, $category, $featured, $active);
...
<head>
    ...
    <title>Add Food - Dashboard</title>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 mt-1">Create a new delicious food item for your menu</p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden animate-fade-in-up">
                <div class="bg-gradient-to-r from-orange-600 to-red-600 p-6">
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="text-2xl font-bold text-white">Food Information</h2>
                    </div>
                </div>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="Enter food title (e.g., Spicy Chicken Pizza, Beef Burger)"
                                   required>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="description" 
                                      ...
                                      placeholder="Describe your delicious food item, ingredients, and what makes it special..."></textarea>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" 
                                   ...
                                   step="0.01"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 input-focus transition-all duration-200"
                                   placeholder="Enter price in Taka (e.g., 299.99)"
                                   required>
                        </div>
                            ...
                            <div class="border-2 border-dashed border-orange-200 rounded-xl p-6 bg-orange-50 hover:bg-orange-100 transition-colors duration-200">
                                <div class="flex items-center justify-center">
                                    <label class="cursor-pointer flex flex-col items-center">
                                        ...
                                        <span class="text-orange-700 font-medium">Choose Food Image</span>
                        ...
                        <div class="space-y-4">
                            <label class="flex items-center text-sm font-semibold text-gray-700 mb-4">
                                <div class="w-8 h-8 bg-pink-100 rounded-lg flex items-center justify-center mr-3">
                                    <i class="fas fa-star text-pink-600 text-sm"></i>
                                </div>
                                Featured Food
                            </label>
                            ...
                            <p class="text-sm text-gray-500">Featured foods appear prominently on the homepage</p>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="text-sm text-gray-500">Only active foods are visible to customers</p>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (categorySelect.value === '' || categorySelect.value === '0') {
                    ...
                    categorySelect.style.boxShadow = '0 0 0 3px rgba(239, 68, 68, 0.2)';
                    hasError = true;
                }
            ...
            inputs.forEach(input => {
                input.addEventListener('focus', function() {
                    ...
                    if (label) label.style.color = '#fb923c';
                });
